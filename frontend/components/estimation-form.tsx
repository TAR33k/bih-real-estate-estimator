...
export function EstimationForm({ onSubmit, isLoading, isResultShown }: EstimationFormProps) {
  ...
  return (
    <motion.div
      ...
      className="w-full glass-panel p-6 md:p-8"
    >
      <motion.div
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  ...
                  <Popover open={locationOpen} onOpenChange={setLocationOpen}>
                    ...
                    <PopoverContent className="w-[--radix-popover-trigger-width] p-0 glass-panel border-none" align="start">
                      <Command>
                        <CommandInput 
                          ...
                          {filteredLocations.map((city) => (
                            ...
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  form.getValues("location") === city ? "opacity-100" : "opacity-0"
                                )}
                              />
                              {city}
                            </CommandItem>
              ...
              {[
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg bg-secondary/40 p-3">
          ...
          >
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 text-base font-semibold bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg hover:shadow-accent/30 transition-all duration-300"
            >
